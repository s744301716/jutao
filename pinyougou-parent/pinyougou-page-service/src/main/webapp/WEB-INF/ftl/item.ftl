				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size>0)>
									<img jqimg="${imageList[0].url}" src="${imageList[0].url}" alt="找不到该图片"  width="400px" height="400px" />
								</#if>
						...
						<div class="spec-scroll">
							...
							<div class="items">
								...
								<#list imageList as item>
									<li><img src="${item.url}" bimg="${item.url}" alt="找不到该图片"  onmousemove="preview(this)" /></li>
								</#list>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								...
								<div class="intro-detail">
									${goodsDesc.introduction!'没有内容'}
								</div>
							</div>
							<div id="two" class="tab-pane">
								<p>${goodsDesc.packageList!'没有内容'}</p>
							</div>
							<div id="three" class="tab-pane">
								<p>${goodsDesc.saleService!'没有内容'}</p>
							</div>
